...
type Config struct {
	...
	// OperatorToken gates the operator endpoints (unattributed-deposit review
	// and attribution). Set GLOBMINT_OPERATOR_TOKEN; empty disables them.
...
func Load() Config {
	return Config{
		...
		OperatorToken:                        os.Getenv("GLOBMINT_OPERATOR_TOKEN"),
